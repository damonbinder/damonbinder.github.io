...
3. Place the pepper, garlic, mint, coriander, and salt into a large mortar, and grind to a paste. Add the honey and feta and continue to grind until homogenous, then add the white wine and olive olive along with 3 Tb of water and mix everything together.  
4. Remove the bread from the vinegar mixture and squeeze to remove excess liquid, then use it to line the serving bowl or other serving dish. Pat down gently to form a single layer.   
5. Pour over the cheese mixture to form a second layer on top, then place the serving bowl in the fridge for several hours to chill before serving.
