...
4. Stir in the salt. For a richer modern serving, stir in the ghee or oil.

**Notes**

* For niṣpāva or whole pigeon peas, omit both turmeric and asafoetida to follow the stated exception.  
* The Sanskrit uses *sūpa* broadly for a pulse preparation; the desired consistency may range from thick dal to pourable soup.
