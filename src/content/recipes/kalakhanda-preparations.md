...
* 1½ tsp rock salt  
* ¼ tsp asafoetida  
* For mustard version: 2 Tb mustard paste  
* For curd version: 150 g yoghurt and 1 tsp mustard  
...
3. For the mustard or curd versions, coat the warm pieces with the chosen dressing.  
4. For the citrus version, slice thinly and toss with citron or lemon pulp and salt.  
5. For the sour-fried version, marinate fatty liver pieces briefly in tamarind water and salt, then fry in oil.

**Notes**

* Kālakhaṇḍa is probably a dark organ, but liver remains a working identification.  
* *Ajājī* may denote cumin, caraway, or related aromatic seed.
