...
var main = (function() {
	...
	function event_grow(i){
		...
		this.width  = ev_width[i];
		this.height = ev_height[i];						
		this.x  = Math.floor(center_x-this.width/2);
		this.y  = Math.floor(ev_y[i]-this.height/2);
	...
	function event_shrink(i){
		...
		if (center_x<event_scale) {
			...
			this.width  = ev_width[i]*ratio;
			this.height = ev_height[i]*ratio;						
		}
		this.x  = Math.floor(center_x-this.width/2);
		this.y  = Math.floor(ev_y[i]-this.height/2);
